  ...
  const [FAQCards, setFAQCards] = useState([
    FAQS.map( item => (
      <Grid item xl={4} lg={4} md={4} sm={12} xs={12}>
         <FAQ image={item.image} icon={item.icon} question={item.question} answer={item.answer} />  
      </Grid>       
     ))
  ]);
    ...
    <div style={{backgroundColor:'#F7F7F7'}}>
        ...
        <Grid container spacing={3}>
          ...
          >
            <Grid 
              ...
              justify="flex-end"
            >
              <Grid item xl={6} style={{display:'flex', direction:'row', justifyContent:'flex-end'}}>
                <CoolButton type="secondary" text="Mapa" width="225" height="60"/>
              </Grid>
              <Grid item xl={6} lg={6}  md={6} sm={6} xs={6} style={{display:'flex', direction:'row', justifyContent:'flex-end'}}>
              <CoolButton type="primary" text="Ingresar" width="225" height="60"/>
              </Grid>  
            </Grid>  
          </Grid> 
        </Grid>  
        <Grid container spacing={3} style={{marginTop:'25px'}}>
          <Grid item xl={5} lg={5} md={5} sm={12}>
            ...
            alignItems="flex-end"
            >
              <Grid item xl={9} lg={9}  md={9} sm={12} xs={12} ref={containerRef}>
                <Slide 
                  direction="right" 
                  appear="true" 
        ...
        >
          <Grid item xl={6} lg={6} md={12} sm={12} xs={12}>
            <CoolLink image="/img/expediciones.jpg" text="Expediciones" height="460" transparency="0.5" href=""/>
          </Grid>    
          <Grid item xl={6} lg={6} md={12} sm={12} xs={12}>
      ...
      <Grid container spacing={2} style={{marginTop:'25px'}}>
        <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
          ...
          >Síguenos en nuestras redes sociales</h1>
        </Grid>
      </Grid>
      ...
      <Grid container spacing={3} style={{marginTop:'25px'}}>
        <Grid item xl={4} lg={4} md={4} sm={12} xs={12}>
             <div style={{backgroundColor:'#E7E4FA', textAlign:'center', color:'#2E2270'}}> 
                <h1>#AGSMAC</h1> 
             </div>
        </Grid>
        <Grid item xl={4} lg={4} md={4} sm={12} xs={12}>
      ...
      >
        ...
        <Grid item xl={2} lg={2} md={2} sm={2} xs={2} style={{display:'flex', justifyContent:'center'}}>
        ...
        <Grid item xl={2} lg={2} md={2} sm={2} xs={2} style={{display:'flex', justifyContent:'center'}}>
          <img src="/img/youtube.png" alt="logo" style={{width:'50px', filter:'invert(17%) sepia(21%) saturate(4315%) hue-rotate(228deg) brightness(92%) contrast(105%)',}}/>
        </Grid> 
      ...
      >
        <Grid item xl={12} lg={12} md={12} sm={12} xs={12} style={{display:'flex', justifyContent:'center'}}>
          <img src="/img/top flowers.png" alt="logo" style={{width:'75%'}}/>
        </Grid>
      </Grid>

      <Grid container spacing={2} style={{marginTop:'25px'}}>
        <Grid item xl={6} lg={6} md={6} sm={12} xs={12} >
          <Grid container spacing={2} style={{display:'flex', justifyContent:'center', alignItems:'center', marginTop:'45px'}}>
            <h1 style={{fontSize:'50px', color:'#2E2270', textAlign:'center'}}>¡Unete a la tropa!</h1>
          </Grid>
          <Grid container spacing={2} style={{display:'flex', justifyContent:'center', alignItems:'center'}}>
            <Grid item xl={12} lg={12} md={12} sm={12} xs={12} style={{display:'flex', justifyContent:'center', alignItems:'center'}}>
              <CoolButton type="secondary" text="Vuelvete un Scout" width="300" height="80" style={{marginBottom:'10px'}} />
            </Grid>
          </Grid>
        </Grid>
        <Grid item xl={6} lg={6} md={6} sm={12} xs={12}>
      ...
      <Grid container spacing={2} style={{marginTop:'25px'}}>
        <Grid item xl={12} lg={12} md={12} sm={12} xs={12} style={{display:'flex', justifyContent:'center'}}>
          <img src="/img/bot flowers.png" alt="logo" style={{width:'75%'}}/>
        </Grid>
      </Grid> 
      </Container>
      <Footer />
